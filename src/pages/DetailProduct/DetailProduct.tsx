                ...
                <div className="pt-6">
                    <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <p className="text-3xl tracking-tight text-red-600">${products.price}</p>
                            ...
                            <form className="mt-10" onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <button type="submit" className="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">Thêm Giỏ Hàng</button>
                            </form>
                        </div>
                        ...
                        <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
                            ...
                            <div className="mt-10">
                                ...
                                <div className="mt-4 space-y-6">
                                    <p className="text-sm text-gray-600">Câu chuyện bắt đầu vào năm 2011 của Hà Nội, khi chúng tôi - những con người yêu Hip-hop và thời trang đường phố tụ họp lại. Một vài người là B-Boy và C-Walker, một số khác là Beatboxer. Nhưng tất cả đều có chung một câu hỏi:
                                        “Chúng ta có thể làm gì cho cộng đồng những người yêu Streetwear và Hip-hop?!</p>
                                </div>
                            </div>
                        </div>
                    </div>
