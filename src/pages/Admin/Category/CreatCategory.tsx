...
import { fetchAllCategory, fetchCreatCategory } from '../../../Redux/Slices/categorySlice';
...
const CreatCategory = () => {
    ...
    const onAdd = async (value: any) => {
        try {
            ...
            await dispatch(fetchCreatCategory(value));
    ...
    return (
        <div>
            <div>
                <h1 className='text-[24px] font-sans font-[700]'>Tạo Danh Mục</h1>
            </div>
